<?php
  ...
  if (pg_num_rows($result) > 0)
  {
    ...
    {
      $direccion_read = '<a href="/admin/users/read.html?id=' . $contador . '" class="btn btn-primary">Ver <i class="fas fa-search"></i></a>';
      //<a href="/admin/users/read.html?id=$ontador" class="btn btn-primary">Ver <i class="fas fa-search"></i></a>
      $direccion_edit = '<a href="/admin/users/update.html?id=' . $contador . '" class="btn btn-warning">Editar <i class="fas fa-edit"></i></a>';
      //'<a href="/admin/users/update.html?id=$contador" class="btn btn-warning">Editar <i class="fas fa-edit"></i></a>'
      $direccion_delete = '<a href="/admin/users/CRUD/delete.php?id=' . $contador . '" class="btn btn-danger">Borrar <i class="fas fa-trash-alt"></i></a>';
